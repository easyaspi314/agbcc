...
static reloc_howto_type elf32_arm_howto_table_1[] =
{
  ...
  HOWTO (R_ARM_PC24, 2, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_PC24", FALSE, 0x00ffffff, 0x00ffffff, TRUE),

  /* 32 bit absolute */
  HOWTO (R_ARM_ABS32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_ABS32", FALSE, 0xffffffff, 0xffffffff, FALSE),

  /* standard 32bit pc-relative reloc */
  HOWTO (R_ARM_REL32, 0, 2, 32, TRUE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_REL32", FALSE, 0xffffffff, 0xffffffff, TRUE),

  /* 8 bit absolute - R_ARM_LDR_PC_G0 in AAELF */
  HOWTO (R_ARM_LDR_PC_G0, 0, 0, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_PC_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),

   /* 16 bit absolute */
  HOWTO (R_ARM_ABS16, 0, 1, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_ABS16", FALSE, 0x0000ffff, 0x0000ffff, FALSE),

  /* 12 bit absolute */
  HOWTO (R_ARM_ABS12, 0, 2, 12, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_ABS12", FALSE, 0x00000fff, 0x00000fff, FALSE),
  HOWTO (R_ARM_THM_ABS5, 6, 1, 5, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_ABS5", FALSE, 0x000007e0, 0x000007e0, FALSE),

  /* 8 bit absolute */
  HOWTO (R_ARM_ABS8, 0, 0, 8, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_ABS8", FALSE, 0x000000ff, 0x000000ff, FALSE),
  HOWTO (R_ARM_SBREL32, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_SBREL32", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_THM_CALL, 1, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_CALL", FALSE, 0x07ff2fff, 0x07ff2fff, TRUE),
  HOWTO (R_ARM_THM_PC8, 1, 1, 8, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_PC8", FALSE, 0x000000ff, 0x000000ff, TRUE),
  HOWTO (R_ARM_BREL_ADJ, 1, 1, 32, FALSE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_BREL_ADJ", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_DESC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_DESC", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_THM_SWI8, 0, 0, 0, FALSE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_SWI8", FALSE, 0x00000000, 0x00000000, FALSE),

  /* BLX instruction for the ARM.  */
  HOWTO (R_ARM_XPC25, 2, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_XPC25", FALSE, 0x00ffffff, 0x00ffffff, TRUE),

  /* BLX instruction for the Thumb.  */
  HOWTO (R_ARM_THM_XPC22, 2, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_XPC22", FALSE, 0x07ff2fff, 0x07ff2fff, TRUE),

  /* Dynamic TLS relocations.  */

  HOWTO (R_ARM_TLS_DTPMOD32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_DTPMOD32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_DTPOFF32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_DTPOFF32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_TPOFF32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_TPOFF32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  ...
  HOWTO (R_ARM_GOTOFF32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_GOTOFF32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  ...
  HOWTO (R_ARM_PLT32, 2, 2, 24, TRUE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_PLT32", FALSE, 0x00ffffff, 0x00ffffff, TRUE),
  HOWTO (R_ARM_CALL, 2, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_CALL", FALSE, 0x00ffffff, 0x00ffffff, TRUE),
  HOWTO (R_ARM_JUMP24, 2, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_JUMP24", FALSE, 0x00ffffff, 0x00ffffff, TRUE),
  HOWTO (R_ARM_THM_JUMP24, 1, 2, 24, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_JUMP24", FALSE, 0x07ff2fff, 0x07ff2fff, TRUE),
  HOWTO (R_ARM_BASE_ABS, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_BASE_ABS", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_ALU_PCREL7_0, 0, 2, 12, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PCREL_7_0", FALSE, 0x00000fff, 0x00000fff, TRUE),
  HOWTO (R_ARM_ALU_PCREL15_8, 0, 2, 12, TRUE, 8, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PCREL_15_8", FALSE, 0x00000fff, 0x00000fff, TRUE),
  HOWTO (R_ARM_ALU_PCREL23_15, 0, 2, 12, TRUE, 16, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PCREL_23_15", FALSE, 0x00000fff, 0x00000fff, TRUE),
  HOWTO (R_ARM_LDR_SBREL_11_0, 0, 2, 12, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_SBREL_11_0", FALSE, 0x00000fff, 0x00000fff, FALSE),
  HOWTO (R_ARM_ALU_SBREL_19_12, 0, 2, 8, FALSE, 12, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SBREL_19_12", FALSE, 0x000ff000, 0x000ff000, FALSE),
  HOWTO (R_ARM_ALU_SBREL_27_20, 0, 2, 8, FALSE, 20, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SBREL_27_20", FALSE, 0x0ff00000, 0x0ff00000, FALSE),
  HOWTO (R_ARM_TARGET1, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_TARGET1", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_ROSEGREL32, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ROSEGREL32", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_V4BX, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_V4BX", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TARGET2, 0, 2, 32, FALSE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_TARGET2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_PREL31, 0, 2, 31, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_PREL31", FALSE, 0x7fffffff, 0x7fffffff, TRUE),
  HOWTO (R_ARM_MOVW_ABS_NC, 0, 2, 16, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_MOVW_ABS_NC", FALSE, 0x000f0fff, 0x000f0fff, FALSE),
  HOWTO (R_ARM_MOVT_ABS, 0, 2, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_MOVT_ABS", FALSE, 0x000f0fff, 0x000f0fff, FALSE),
  HOWTO (R_ARM_MOVW_PREL_NC, 0, 2, 16, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_MOVW_PREL_NC", FALSE, 0x000f0fff, 0x000f0fff, TRUE),
  HOWTO (R_ARM_MOVT_PREL, 0, 2, 16, TRUE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_MOVT_PREL", FALSE, 0x000f0fff, 0x000f0fff, TRUE),
  HOWTO (R_ARM_THM_MOVW_ABS_NC, 0, 2, 16, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_MOVW_ABS_NC", FALSE, 0x040f70ff, 0x040f70f, FALSE),
  HOWTO (R_ARM_THM_MOVT_ABS, 0, 2, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_MOVT_ABS", FALSE, 0x040f70ff, 0x040f70ff, FALSE),
  HOWTO (R_ARM_THM_MOVW_PREL_NC, 0, 2, 16, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_MOVW_PREL_NC", FALSE, 0x040f70ff, 0x040f70ff, TRUE),
  HOWTO (R_ARM_THM_MOVT_PREL, 0, 2, 16, TRUE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_MOVT_PREL", FALSE, 0x040f70ff, 0x040f70ff, TRUE),
  HOWTO (R_ARM_THM_JUMP19, 1, 2, 19, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_JUMP19", FALSE, 0x043f2fff, 0x043f2fff, TRUE),
  HOWTO (R_ARM_THM_JUMP6, 1, 1, 6, TRUE, 0, complain_overflow_unsigned, bfd_elf_generic_reloc, "R_ARM_THM_JUMP6", FALSE, 0x02f8, 0x02f8, TRUE),

  /* These are declared as 13-bit signed relocations because we can
     address -4095 .. 4095(base) by altering ADDW to SUBW or vice
     versa.  */
  HOWTO (R_ARM_THM_ALU_PREL_11_0, 0, 2, 13, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_ALU_PREL_11_0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_THM_PC12, 0, 2, 13, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_PC12", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ABS32_NOI, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ABS32_NOI", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_REL32_NOI, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_REL32_NOI", FALSE, 0xffffffff, 0xffffffff, FALSE),

  /* Group relocations.  */

  HOWTO (R_ARM_ALU_PC_G0_NC, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PC_G0_NC", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_PC_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PC_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_PC_G1_NC, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PC_G1_NC", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_PC_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PC_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_PC_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_PC_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDR_PC_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_PC_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDR_PC_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_PC_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDRS_PC_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDRS_PC_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDRS_PC_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDRS_PC_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDRS_PC_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDRS_PC_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDC_PC_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDC_PC_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDC_PC_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDC_PC_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDC_PC_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDC_PC_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_SB_G0_NC, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SB_G0_NC", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_SB_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SB_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_SB_G1_NC, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SB_G1_NC", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_SB_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SB_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_ALU_SB_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_ALU_SB_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDR_SB_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_SB_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDR_SB_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_SB_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDR_SB_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDR_SB_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDRS_SB_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDRS_SB_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDRS_SB_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDRS_SB_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDRS_SB_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDRS_SB_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDC_SB_G0, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDC_SB_G0", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDC_SB_G1, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDC_SB_G1", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_LDC_SB_G2, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_LDC_SB_G2", FALSE, 0xffffffff, 0xffffffff, TRUE),

  /* End of group relocations.  */

  HOWTO (R_ARM_MOVW_BREL_NC, 0, 2, 16, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_MOVW_BREL_NC", FALSE, 0x0000ffff, 0x0000ffff, FALSE),
  HOWTO (R_ARM_MOVT_BREL, 0, 2, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_MOVT_BREL", FALSE, 0x0000ffff, 0x0000ffff, FALSE),
  HOWTO (R_ARM_MOVW_BREL, 0, 2, 16, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_MOVW_BREL", FALSE, 0x0000ffff, 0x0000ffff, FALSE),
  HOWTO (R_ARM_THM_MOVW_BREL_NC, 0, 2, 16, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_MOVW_BREL_NC", FALSE, 0x040f70ff, 0x040f70ff, FALSE),
  HOWTO (R_ARM_THM_MOVT_BREL, 0, 2, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_MOVT_BREL", FALSE, 0x040f70ff, 0x040f70ff, FALSE),
  HOWTO (R_ARM_THM_MOVW_BREL, 0, 2, 16, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_MOVW_BREL", FALSE, 0x040f70ff, 0x040f70ff, FALSE),
  HOWTO (R_ARM_TLS_GOTDESC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, NULL, "R_ARM_TLS_GOTDESC", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_CALL, 0, 2, 24, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_TLS_CALL", FALSE, 0x00ffffff, 0x00ffffff, FALSE),
  HOWTO (R_ARM_TLS_DESCSEQ, 0, 2, 0, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_DESCSEQ", FALSE, 0x00000000, 0x00000000, FALSE),
  HOWTO (R_ARM_THM_TLS_CALL, 0, 2, 24, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_THM_TLS_CALL", FALSE, 0x07ff07ff, 0x07ff07ff, FALSE),
  HOWTO (R_ARM_PLT32_ABS, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_PLT32_ABS", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_GOT_ABS, 0, 2, 32, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_GOT_ABS", FALSE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_GOT_PREL, 0, 2, 32, TRUE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_GOT_PREL", FALSE, 0xffffffff, 0xffffffff, TRUE),
  HOWTO (R_ARM_GOT_BREL12, 0, 2, 12, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_GOT_BREL12", FALSE, 0x00000fff, 0x00000fff, FALSE),
  HOWTO (R_ARM_GOTOFF12, 0, 2, 12, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_GOTOFF12", FALSE, 0x00000fff, 0x00000fff, FALSE),

  EMPTY_HOWTO (R_ARM_GOTRELAX),/* reserved for future GOT-load optimizations */

  /* GNU extension to record C++ vtable member usage */
  HOWTO (R_ARM_GNU_VTENTRY, 0, 2, 0, FALSE, 0, complain_overflow_dont, _bfd_elf_rel_vtable_reloc_fn, "R_ARM_GNU_VTENTRY", FALSE, 0, 0, FALSE),

  /* GNU extension to record C++ vtable hierarchy */
  HOWTO (R_ARM_GNU_VTINHERIT, 0, 2, 0, FALSE, 0, complain_overflow_dont, NULL, "R_ARM_GNU_VTINHERIT", FALSE, 0, 0, FALSE),
  HOWTO (R_ARM_THM_JUMP11, 1, 1, 11, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_JUMP11", FALSE, 0x000007ff, 0x000007ff, TRUE),
  HOWTO (R_ARM_THM_JUMP8, 1, 1, 8, TRUE, 0, complain_overflow_signed, bfd_elf_generic_reloc, "R_ARM_THM_JUMP8", FALSE, 0x000000ff, 0x000000ff, TRUE),

  /* TLS relocations */
  HOWTO (R_ARM_TLS_GD32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, NULL, "R_ARM_TLS_GD32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_LDM32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_LDM32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_LDO32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_LDO32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_IE32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, NULL, "R_ARM_TLS_IE32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_LE32, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, NULL, "R_ARM_TLS_LE32", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_LDO12, 0, 2, 12, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_LDO12", FALSE, 0x00000fff, 0x00000fff, FALSE),
  HOWTO (R_ARM_TLS_LE12, 0, 2, 12, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_LE12", FALSE, 0x00000fff, 0x00000fff, FALSE),
  HOWTO (R_ARM_TLS_IE12GP, 0, 2, 12, FALSE , 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_IE12GP", FALSE, 0x00000fff, 0x00000fff, FALSE),
  ...
  HOWTO (R_ARM_THM_TLS_DESCSEQ, 0, 1, 0, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_TLS_DESCSEQ", FALSE, 0x00000000, 0x00000000, FALSE),
  EMPTY_HOWTO (130),
  EMPTY_HOWTO (131),
  ...
  HOWTO (R_ARM_THM_ALU_ABS_G0_NC,	/* type.  */
	 ...
	 0x00000000,			/* dst_mask.  */
	 FALSE),		/* pcrel_offset.  */
  HOWTO (R_ARM_THM_ALU_ABS_G1_NC, 0, 1, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_ALU_ABS_G1_NC", FALSE, 0x00000000, 0x00000000, FALSE),
  HOWTO (R_ARM_THM_ALU_ABS_G2_NC, 0, 1, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_ALU_ABS_G2_NC", FALSE, 0x00000000, 0x00000000, FALSE),
  HOWTO (R_ARM_THM_ALU_ABS_G3_NC, 0, 1, 16, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_THM_ALU_ABS_G3_NC", FALSE, 0x00000000, 0x00000000, FALSE)
};

/* 160 onwards: */
static reloc_howto_type elf32_arm_howto_table_2[8] =
{
  HOWTO (R_ARM_IRELATIVE, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_IRELATIVE", TRUE, 0xffffffff, 0xffffffff, FALSE),
  HOWTO (R_ARM_GOTFUNCDESC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_GOTFUNCDESC", FALSE, 0, 0xffffffff, FALSE),
  HOWTO (R_ARM_GOTOFFFUNCDESC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_GOTOFFFUNCDESC", FALSE, 0, 0xffffffff, FALSE),
  HOWTO (R_ARM_FUNCDESC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_FUNCDESC", FALSE, 0, 0xffffffff, FALSE),
  HOWTO (R_ARM_FUNCDESC_VALUE, 0, 2, 64, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_FUNCDESC_VALUE", FALSE, 0, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_GD32_FDPIC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_GD32_FDPIC", FALSE, 0, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_LDM32_FDPIC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_LDM32_FDPIC", FALSE, 0, 0xffffffff, FALSE),
  HOWTO (R_ARM_TLS_IE32_FDPIC, 0, 2, 32, FALSE, 0, complain_overflow_bitfield, bfd_elf_generic_reloc, "R_ARM_TLS_IE32_FDPIC", FALSE, 0, 0xffffffff, FALSE),
};

/* 249-255 extended, currently unused, relocations:  */
static reloc_howto_type elf32_arm_howto_table_3[4] =
{
  HOWTO (R_ARM_RREL32, 0, 0, 0, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_RREL32", FALSE, 0, 0,FALSE),
  HOWTO (R_ARM_RABS32, 0, 0, 0, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_RABS32", FALSE, 0, 0,FALSE),
  HOWTO (R_ARM_RPC24, 0, 0, 0, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_RPC24", FALSE, 0, 0,FALSE),
  HOWTO (R_ARM_RBASE, 0, 0, 0, FALSE, 0, complain_overflow_dont, bfd_elf_generic_reloc, "R_ARM_RBASE", FALSE, 0, 0,FALSE)
};
...
typedef uint32_t insn32;
typedef uint16_t insn16;
...
static const uint32_t tls_trampoline [] =
{
...
static const uint32_t dl_tlsdesc_lazy_trampoline [] =
{
  0xe52d2004, /*	push    {r2}			*/
...
elf32_arm_create_local_iplt (bfd *abfd, uint32_t r_symndx)
{
...
elf32_arm_get_plt_info (bfd *abfd, struct elf32_arm_link_hash_table *globals,
			struct elf32_arm_link_hash_entry *h,
			uint32_t r_symndx, union gotplt_union **root_plt,
...
elf32_arm_get_local_dynreloc_list (bfd *abfd, uint32_t r_symndx,
...
elf32_arm_tls_relax (struct elf32_arm_link_hash_table *globals,
		     ...
		     Elf_Internal_Rela *rel, uint32_t is_local)
{
  uint32_t insn;
  ...
  switch (ELF32_R_TYPE (rel->r_info))
      ...
      else
	{
	  ...
	  _bfd_error_handler
	    /* xgettext:c-format */
	    (_("%pB(%pA+%#" PRIx64 "): "
	       "unexpected %s instruction '%#x' in TLS trampoline"),
...
arm_put_trampoline (struct elf32_arm_link_hash_table *htab, bfd *output_bfd,
		    void *contents,
		    const uint32_t *template, unsigned count)
{
  unsigned ix;

  for (ix = 0; ix != count; ix++)
    {
      uint32_t insn = template[ix];
...
static uint32_t
offset_prel31 (uint32_t addr, bfd_vma offset)
{
  return (addr & ~0x7fffffff) | ((addr + offset) & 0x7fffffff);
}
...
{
  uint32_t first_word = bfd_get_32 (output_bfd, from);
  uint32_t second_word = bfd_get_32 (output_bfd, from + 4);
  ...
  if ((second_word != 0x1) && ((second_word & 0x80000000) == 0))
